...
-- generates HTML web site
    conn:send('HTTP/1.1 200 OK\r\n Content-type: text/html\r\n\r\n<!DOCTYPE HTML>    <html>    <head><meta  content="text/html; charset=utf-8">    <title>ESP8266</title></head>    <body><h3>Sample GPIO output control</h3><form action="" method="post">    <input type="submit" name="pwmi" value="OFF">    <input type="submit" name="pwmi" value="10">    <input type="submit" name="pwmi" value="20">    <input type="submit" name="pwmi" value="30">    <input type="submit" name="pwmi" value="40">    <input type="submit" name="pwmi" value="50">    <input type="submit" name="pwmi" value="60">    <input type="submit" name="pwmi" value="70">    <input type="submit" name="pwmi" value="80">    <input type="submit" name="pwmi" value="90">    <input type="submit" name="pwmi" value="ON"><font color="red"><big><big>'..' '..setpower..' '..'% of power</big></big></font><font color="black"><br></font><br><input type="submit" name="pwmi" value="FLC"> HW blinker</form><br><br><IMG SRC="http://esp8266.fancon.cz/common/led.gif" WIDTH="150" HEIGHT="101" BORDER="1"></body></html>')
