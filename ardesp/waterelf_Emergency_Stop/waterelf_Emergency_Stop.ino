...
/////////////////////////////////////////////////////////////////////////////
// level & Emergency stop sensing stuff /////////////////////////////////////
...
static volatile unsigned long lastLow,lastHigh = 0; // Initialises first time round only, persists across invocations
...
void loop() {
  ...
  if(lastLow<lastHigh && lastHigh+500<micros()){
      Serial.println("** STOP **");
      lastLow,lastHigh=0;
  }
  if(lastHigh<lastLow && lastLow+500<micros()){
...
void startPeripherals() {
  ...
  attachInterrupt(EMERGENCY_PIN, isr, CHANGE);
...
void isr() // This is called when the emergency stop button changes state
{
