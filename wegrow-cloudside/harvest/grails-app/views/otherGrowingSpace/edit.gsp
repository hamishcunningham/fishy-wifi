...
<html>
    ...
    <body>
        <div id="edit-otherGrowingSpace" class="content scaffold-edit" role="main">
            ...
            <g:form resource="${this.otherGrowingSpace}" method="PUT">
                <g:hiddenField name="version" value="${this.otherGrowingSpace?.version}" />
                <fieldset class="form">
